...
export default function InstructorRequest() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (files.length === 0) {
            setFileError(
                t("pages.instructor_request.errors.document_required")
            );
            return;
        }
        ...
        try {
            ...
            toast.success(
                t("pages.instructor_request.success")
            );
            ...
            toast.error(
                error.message ||
                    t("pages.instructor_request.errors.submit_error")
            );
        } finally {
            setLoading(false);
        }
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="w-full rounded-lg border border-richblack-600 bg-richblack-900 px-4 py-3 outline-none focus:border-yellow-50"
                            placeholder={t(
                                "pages.instructor_request.about_placeholder"
                            )}
                        />
                    </div>
                    ...
                    <div>
                        ...
                        >
                            <span className="text-sm text-richblack-300">
                                {t(
                                    "pages.instructor_request.upload_hint",
                                    {
                                        size: MAX_FILE_SIZE_MB,
                                    }
                                )}
                            ...
                            <ul className="mt-3 space-y-2">
                                {files.map((file, index) => (
                                    ...
                                    >
                                        ...
                                        >
                                            {t(
                                                "pages.instructor_request.remove"
                                            )}
                                        </button>
                                    </li>
                                ))}
                    ...
                    <div className="flex flex-wrap gap-3 pt-2">
                        ...
                        >
                            {loading
                                ? t(
                                      "pages.instructor_request.submitting"
                                  )
                                : t(
                                      "pages.instructor_request.submit"
                                  )}
                        </button>
